        ...
        <div id="objects" className={styles.container}>
            ...
            <div className={styles.card}>
                <div className={styles.imgBlock}>
                    <img className={styles.CompanyObjectsIMG1} src={CompanyObjectsIMG1} alt="" />
                </div>
            ...
            <div className={styles.cardRevers}>
                ...
                <div className={styles.imgBlock}>
                    <img className={styles.CompanyObjectsIMG2} src={CompanyObjectsIMG2} alt="" />
                </div>
            </div>
            <div className={styles.card}>
                <div className={styles.imgBlock}>
                    <img className={styles.CompanyObjectsIMG3} src={CompanyObjectsIMG3} alt="" />
                </div>
                <div className={styles.textBlock}>
